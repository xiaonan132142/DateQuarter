  ...
  <div class="wrap">
    ...
    >
      <div class="dateWrap" @click.stop>
        ...
        >
        <el-button class="btn" @click="handlePick(4)"
          ><span>第二季度</span></el-button
        >
        <el-button class="btn" @click="handlePick(7)"
          ><span>第三季度</span></el-button
        >
        <el-button class="btn" @click="handlePick(10)"
          ><span>第四季度</span></el-button
        >
      </div>
    </el-popover>
  </div>
...
export default {
  name: "highDatepicker",
  inheritAttrs: false,
  props: ["value", "type", "format", "readonly"],
  model: {
    prop: "value",
    event: "change"
  },
